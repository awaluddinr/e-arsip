<form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="form-group mb-3">
                ...
                <input type="text"
                    class="form-control @error('asal')
                is-invalid
            @enderror" name="asal"
                    id="asal" placeholder="Enter asal" value="{{ old('asal') }}">
                @error('asal')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="form-group mb-3">
                ...
                is-invalid
            @enderror"
                    name="no-surat" id="no-surat" placeholder="Enter No. surat" value="{{ old('no-surat') }}">
                @error('no-surat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group mb-3">
                ...
                is-invalid
            @enderror"
                    name="perihal" id="perihal" placeholder="perihal" value="{{ old('perihal') }}">
                @error('perihal')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group mb-3">
                <label for="date" class="mb-0">Tanggal Diterima</label>
                <input type="date"
                    class="form-control @error('tanggal-diterima')
                is-invalid
            @enderror"
                    name="tanggal-diterima" id="date" placeholder="date" value="{{ old('tanggal-diterima') }}">
        ...
        <div class="col-lg-6">
            <div class="form-group mb-3">
                ...
                is-invalid
            @enderror"
                    name="tanggal-surat" id="date" placeholder="date" value="{{ old('tanggal-surat') }}">
                @error('tanggal-surat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
