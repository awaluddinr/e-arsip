    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="form-group mb-3">
                ...
                <input type="text"
                    class="form-control @error('asal_surat')
                is-invalid
            @enderror"
                    id="asal" name="asal_surat" placeholder="Enter asal"
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group mb-2">
                ...
                <input type="date"
                    class="form-control @error('tanggal_diterima_surat')
                is-invalid
            @enderror"
                    name="tanggal_diterima_surat" id="date" placeholder="date"
                    value="{{ old('tanggal_diterima_surat', $surat->tanggal_diterima_surat) }}">
                @error('tanggal_diterima_surat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
