                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <iframe class="d-none" id="textfile{{ $data->id }}"
                                                                    src="{{ route('surat-keluar.lihat', $data->id) }}"
                                                                    frameborder="0">
                                                                </iframe>
                                                                ...
                                                                <a href="{{ route('surat-keluar.download', $data->id) }}"
                                                                    class="btn btn-info">
...
@push('js')
    ...
    <script>
        ...
        function updateExportLinkHref() {
            // exportLink.href = "{{ route('print-keluar.view', ['print' => ':filter']) }}".replace(':filter', selectedFilterInput
            //     .value);

            // link di enkripsi
            exportLink.href = "{{ route('print-keluar.view', ['print' => ':filter']) }}".replace(':filter',
                encodeURIComponent(
