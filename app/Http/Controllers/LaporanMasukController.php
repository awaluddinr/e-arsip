...
class LaporanMasukController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('main-layouts.laporan-surat.laporan-surat-masuk', compact('surat', 'filter'));
    }
    ...
    public function print_view($print)
    {
        ...
        return view('main-layouts.laporan-surat._surat-masuk-print', compact('surat', 'decodedFilter'));
    }
}
