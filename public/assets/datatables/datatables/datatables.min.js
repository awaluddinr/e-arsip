 ...
 *   https://datatables.net/download/#dt/dt-1.11.4/af-2.3.7/fc-4.0.2/fh-3.2.2/r-2.2.9/sc-2.0.5
 *
 * Included libraries:
 *   DataTables 1.11.4, AutoFill 2.3.7, FixedColumns 4.0.2, FixedHeader 3.2.2, Responsive 2.2.9, Scroller 2.0.5
 */
...
(function (l) {
    ...
    u.ext = M = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.11.4/af-2.3.7/fc-4.0.2/fh-3.2.2/r-2.2.9/sc-2.0.5",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (c) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function (a, b) {
              ...
              b.fn.dataTable.AutoFill ||
                  require("datatables.net-autofill")(a, b);
              return c(b, a, a.document);
          })
        : c(jQuery, window, document);
})(function (c, a, b, d) {
    ...
    var a,
        ...
        k = (function () {
            ...
            e.prototype._setKeyTableListener = function () {
                ...
                this.s.dt.on("column-visibility", function (g, m) {
                    m.bDestroying ||
                        setTimeout(function () {
                            d._addStyles();
                        }, 50);
...
$jscomp.polyfill = function (b, h, g, l) {
    h &&
        ($jscomp.ISOLATE_POLYFILLS
            ? $jscomp.polyfillIsolated(b, h, g, l)
            : $jscomp.polyfillUnisolated(b, h, g, l));
};
...
(function (b) {
    ...
    b.extend(t.prototype, {
        ...
        _constructor: function () {
            ...
            !this.c.headerOffset &&
                c.length &&
                (this.c.headerOffset = c.outerHeight());
            c = b(".fh-fixedFooter");
            !this.c.footerOffset &&
                c.length &&
                (this.c.footerOffset = c.outerHeight());
            d.on(
                        ...
                        "auto" === e || f
                            ? "auto" !== p &&
                              ...
                              ((e =
                                  +p.replace(/px/g, "") +
                                  ("-" === d ? -1 : 1) *
                                      c.s.dt.settings()[0].oBrowser.barWidth),
        ...
        _unsize: function (a) {
            ...
            d && ("footer" === a || ("header" === a && !this.s.autoWidth))
                ? b("th, td", d).css({ width: "", minWidth: "" })
        ...
        _modeChange: function (a, d, c) {
            ...
            if ("footer" !== d || !p) {
                var q = function (B) {
                        ...
                        p ||
                            f.floatingParent.attr("style", function (x, y) {
                                return (
                                    (y || "") + "width: " + B + "px !important;"
                                );
                            });
                    },
                    n = this.dom["footer" === d ? "tfoot" : "thead"],
                    r = b.contains(n[0], g.activeElement)
                        ? g.activeElement
                        : null,
                ...
                if ("in-place" === a)
                    f.placeholder &&
                        ...
                        this._unsize(d),
                        "header" === d ? f.host.prepend(n) : f.host.append(n),
                        f.floating &&
                            (f.floating.remove(),
                            (f.floating = null),
                    ...
                    c =
                        "footer" === d
                            ? z > u
                                ? e.tfootHeight
                                : z + e.tfootHeight - u
                            : c + this.c.headerOffset + e.theadHeight - m;
                    ...
                    f.floatingParent
                        ...
                        .css({
                            left: e.left,
                            height:
                                "header" === d ? e.theadHeight : e.tfootHeight,
                            "z-index": 2,
                        })
                        .append(f.floating);
                    q(e.width);
        ...
        _positions: function () {
            ...
            a.length
                ? ((c.tfootTop = c.tbodyTop + c.tbodyHeight),
                  (c.tfootBottom = c.tfootTop + a.outerHeight()),
                  (c.tfootHeight = a.outerHeight()))
                : ((c.tfootTop = c.tbodyTop + f.outerHeight()),
                  (c.tfootBottom = c.tfootTop),
                  (c.tfootHeight = c.tfootTop));
        },
        _scroll: function (a) {
            if (!this.s.dt.settings()[0].bDestroying) {
                ...
                this.c.header &&
                    (this.s.enable
                        ? !m.visible ||
                          q + this.c.headerOffset + m.theadHeight <= u
                            ? (n = "in-place")
                            : q + this.c.headerOffset + m.theadHeight > u &&
                              q + this.c.headerOffset < e
                            ? ((n = "in"),
                              (c = b(b(this.s.dt.table().node()).parent())),
                              q + this.c.headerOffset + m.theadHeight > e ||
                            ...
                            : (n = "below")
                        : (n = "in-place"),
                    (a || n !== this.s.headerMode) &&
                        this._modeChange(n, "header", a),
                ...
                this.c.footer &&
                    ...
                    d &&
                        ...
                        (r =
                            ...
                            (d > -x.height ? d : 0) -
                            (x.offset.top +
                                (d < -x.height ? x.height : 0) +
                                y.height)),
                        0 > r && (r = 0),
                        c.outerHeight(r),
                        Math.round(c.outerHeight()) >= Math.round(r)
                ...
                this.s.dt.settings()[0]._fixedColumns !== l &&
                    ...
                    (this.dom.header.rightBlocker = c(
                        "right",
                        "top",
                        this.dom.header.rightBlocker
                    )),
                    (this.dom.header.leftBlocker = c(
                        "left",
                        "top",
                        this.dom.header.leftBlocker
                    )),
                    (this.dom.footer.rightBlocker = c(
                        "right",
                        "bottom",
                        this.dom.footer.rightBlocker
                    )),
                    (this.dom.footer.leftBlocker = c(
                        "left",
                        "bottom",
    ...
    b(g).on("init.dt.dtfh", function (a, d, c) {
        "dt" === a.namespace &&
            ((a = d.oInit.fixedHeader),
            (c = k.defaults.fixedHeader),
            (!a && !c) ||
                d._fixedHeader ||
                ((c = b.extend({}, c, a)), !1 !== a && new t(d, c)));
    });
